...
<head>
    ...
    <style>
        /* Background colors green and yellow */
        body {
...
<main>
    <section id="orientation" aria-label="College Orientation">
        ...
        <img src="https://i.imgur.com/VjvJPyt.jpg" alt="Group photo of freshmen during college orientation" />
    </section>
    ...
    <section id="sinag-concert" aria-label="Sinag Tams Concert Activities">
        ...
        <img src="https://i.imgur.com/8qP8Fc7.jpg" alt="Students enjoying Sinag Tams concert at night" />
        <audio controls>
    ...
    <section id="sinag-sports" aria-label="Sinag Tams Sports Activities">
        ...
        <div class="gallery" aria-label="Images from Sinag Tams Sports activities">
            <img src="https://i.imgur.com/ZNQ5JBb.jpg" alt="Students in cultural costumes during Sinag Sports" />
            <img src="https://i.imgur.com/F2lNiqV.jpg" alt="Students gathered during Sinag Sports event" />
        </div>
    </section>
...
<footer>
    <p>&copy; 2024 FEU-Roosevelt Freshmen Journey</p>
</footer>
